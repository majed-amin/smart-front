        ...
        <>
            <div className="relative py-20 bg-[#00264E] rounded-3xl">
                ...
                <div className={"flex flex-col items-center z-10 justify-center mt-30"}>
                    <div className="flex flex-row items-center bg-[#A2CEFF]/20 max-w-[752px] px-[32px] py-[15px] rounded-2xl">
                        <img src={ComplianceLogo} alt="FATOORA" className="me-13 w-[87px]"/>

                        <p className="text-base font-medium text-white">جميع الباقات تدعم الفاتورة الإلكترونية ومتوافقة مع هيئة الزكاة والضريبة والجمارك</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center mt-12">
                        ...
                        <p className={"leading-[160%] text-[16px] text-[20px] text-center text-[#ECECEC]/65 font-medium max-w-[826px] mt-[24px]"}>
